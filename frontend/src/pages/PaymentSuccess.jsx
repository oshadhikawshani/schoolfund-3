    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 max-w-md w-full">
        <div className="text-center">
          ...
          {/* Message */}
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Thank you in advance!</h1>
          <p className="text-gray-600 mb-6">Your contribution will make a real difference.</p>

          {/* Action Buttons */}
          <div className="space-y-3">
            <Link
              to="https://donate.stripe.com/test_cNi6oGcEG1c5fzmeuhgEg00"
